...
public class SimpleCRUD {
	...
	public static void TC2getUserDetails() {
		...
		System.out.println("id====" + getdata[0].getId());
	}

	/*
	 * Testcase 5 resouce endpoint = /employee/{id} get the details of user whose id
	 * is 2 Http method=get validate fallowing status code is 200 content type is
	 * json employee name is Garrett Winters employee salary is 170750 employee age
	 * is 63 fetch the message data and print it to console
	 */
	@Test(enabled = true)
	...
	/*
	 * resouce endpoint = /delete/{id} get the id from create testcase 2 Http
	 * method=delete sample response { "status": "", "data": "", "message": "" }
	 * 
	 * validate for status code is 200 response body status is "success" id which
	 * you have entered in the path parameter is same as in the response fetch the
	 * message data and print it to console
	 */
